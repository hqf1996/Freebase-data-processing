...
public class mymain {
    ...
    public static Logger LOG = LoggerFactory.getLogger(mymain.class);
...
//        conf.set("mapreduce.textoutputformat.separator", ",");
        Job job = Job.getInstance(conf, "freebase_parse");
        job.setJarByClass(step1.class);
        job.setMapperClass(step1.extractFreebaseMap.class);
        job.setReducerClass(step1.extractFreebaseReuce.class);
