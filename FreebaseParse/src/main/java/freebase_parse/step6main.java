 ...
 * @Modified By:
 */
public class step6main {
    public static String fs = "hdfs://10.1.13.111:8020";//hdfs://10.1.18.221:8020   psd:hdu52335335
    public static Logger LOG = LoggerFactory.getLogger(step6main.class);
...
//        conf.set("mapreduce.textoutputformat.separator", ",");
        ...
        job.setMapperClass(step6.mergeIDSameMap.class);
        job.setReducerClass(step6.mergeIDSameReduce.class);
