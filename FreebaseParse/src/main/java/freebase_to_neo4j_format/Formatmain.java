...
public class Formatmain {
    ...
    public static Logger LOG = LoggerFactory.getLogger(Formatmain.class);
...
//        conf.set("mapreduce.textoutputformat.separator", ",");
        Job job = Job.getInstance(conf, "freebase_format");
        job.setJarByClass(format_duplicate.class);
        job.setMapperClass(format_duplicate.FormatMap.class);
        job.setReducerClass(format_duplicate.FormatReduce.class);
